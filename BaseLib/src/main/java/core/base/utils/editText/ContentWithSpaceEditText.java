package core.base.utils.editText;
...
/**
 * Created by hzlinxuanxuan on 2015/12/22. 该控件是支持输入时自带控件的，目前支持xml属性指定，也支持代码指定该输入卡所属的类型 现在支持：电话、卡号、身份证号，或者无类型（正常输入）
 */
...
public class ContentWithSpaceEditText extends EditText {
	...
	/**
	 * 这里提供了一种新思路，可以把判断手机号是否正确的逻辑写在控件中
	 * @return
	 */
