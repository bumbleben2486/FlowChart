package core.base.views.gallery.largeimage;
...
import core.base.views.gallery.zoomable.DoubleTapGestureListener;
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        if (mData != null && mData.size() > position) {
            ...
            if (mImageViewList != null && mImageViewList.length > position && mImageViewList[position] != null) {
                ...
                zoomableDraweeView.setAllowTouchInterceptionWhileZoomed(true);//true
                // needed for double tap to zoom
                zoomableDraweeView.setIsLongpressEnabled(false);//false
