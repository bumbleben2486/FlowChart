...
public class LargeImageGallery extends FrameLayout {
    ...
    public void setData(List<String> urls) {
        if (urls != null) {
            mAdapter.setData(urls, R.drawable.def_mdd_icon, R.drawable.def_mdd_icon);
            if (urls.size() > 0 && mOnSelectionChangedListener != null) {
    ...
    public interface OnItemLongClickListener {
        ...
        void onItemLongClick(int currentIndex);
    }
}
