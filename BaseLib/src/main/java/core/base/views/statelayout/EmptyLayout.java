package core.base.views.statelayout;
...
public class EmptyLayout {
    ...
    public void setLoadingViewRes(int res) {
        this.mLoadingView = mInflater.inflate(res, null);
    }
    ...
    public void setEmptyViewRes(int res) {
        this.mEmptyView = mInflater.inflate(res, null);
    }
    ...
    public void setErrorViewRes(int res) {
        this.mErrorView = mInflater.inflate(res, null);
    }
    ...
    private void changeEmptyType() {
        ...
        if (!mViewsAdded) {
            ...
            if (mEmptyView != null) rl.addView(mEmptyView,params);
            if (mLoadingView != null) rl.addView(mLoadingView,params);
            if (mErrorView != null) rl.addView(mErrorView,params);

            mViewsAdded = true;
            if(mListView != null){
                ((ViewGroup) mListView.getParent()).addView(rl,params);
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            mEmptyView =  mInflater.inflate(R.layout.empty_empty_view, null);
        ...
        if (mLoadingView == null) {
            mLoadingView =  mInflater.inflate(R.layout.empty_loading_view, null);
        ...
        if (mErrorView == null) {
            mErrorView =  mInflater.inflate(R.layout.empty_error_view, null);
     ...
     */
    public EmptyLayout(Context context, AbsListView listView) {
        mContext = context;
        mInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mListView = listView;
    }
