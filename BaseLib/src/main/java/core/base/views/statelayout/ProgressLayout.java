...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LoadProgressLayout);
        int backgroundColor = a.getColor(R.styleable.LoadProgressLayout_loadProgressBackground, Color.TRANSPARENT);
        boolean progress = a.getBoolean(R.styleable.LoadProgressLayout_loadProgress, false);
        a.recycle();
